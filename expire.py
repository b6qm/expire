...
authorized_users = [1296559148, 5966873984, 1296559148, 6695873549, 5702803191, 6174126557, 5612427625, 1970257616, 7408511525, 912917157, 6603688300, 5123986264, 6609362604, 1418522621, 2084607021, 6084792010, 1544900384, 2104799478, 2093600923]
...
for P in file.readlines():
    ...
    headers = {
        ...
        'authorization': 'Bearer eyJ0eXAiOiJKV1QiLCJhbGciOiJFUzI1NiIsImtpZCI6IjIwMTgwNDI2MTYtcHJvZHVjdGlvbiIsImlzcyI6Imh0dHBzOi8vYXBpLmJyYWludHJlZWdhdGV3YXkuY29tIn0..TgihCyHbfrXXeJMACR3z2GuwQfB1RqN7JTabUYIvvsIoMKtaf7YHEq-toJPi4W32-jNrREjAwOICzHCToJTAfA',
    ...
    json_data = {
        'clientSdkMetadata': {
            'source': 'client',
            'integration': 'custom',
            'sessionId': '367a94b5-c7e4-49ac-9900-ba0d68aaa92d',
        },
